...
export const Navbar = ({
  ...
  return (
    <motion.div
      ...
      className={cn("fixed left-35 right-35 w-auto top-4 z-40", className)}>
      ...
      {items.map((item, idx) => (
        <a
          ...
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="text-white absolute inset-0 h-full w-full rounded-full bg-neutral-400/50 dark:bg-neutral-800" />
          )}
  ...
  return (
    <a
      ...
      <img
        ...
        width={30}
        height={30} />
      <span className="font-semibold text-xs text-black dark:text-white">University Research<br />Collab Platform</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-blue-400 to-blue-600 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
